...
`r icon::fa("spinner", size = 2, animate = "spin")` Descargue la información de Covid-19 🦠  para Colombia desde 🔗**[Datos Abiertos.](https://www.datos.gov.co/)** Esta base de datos está cerca de los 5 millones de registros, puede ralentizar su PC. Importe los datos a R. Y proponga estadísticas descriptivas para las variables que identifique cuantitativas agrupándolas por variables cualitativas.
